...
if( if10(sd_5htt[,"female"]) & if10(sd_5htt[,"age"]) ) {  
 ...
 ##############################
  ...
  file_label <- "_SNPxStress_OtherThanChildMal_AllAges_no_tlimit_"
...
cat("=== END of non-childhood maltreatment stress age unrestricted models with no time restriction", "\n")
